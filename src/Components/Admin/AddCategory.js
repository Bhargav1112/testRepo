    ...
    >
      <DialogTitle id="alert-dialog-title" className="md:w-[600px] w-[300]">
        <div className="w-full relative p-6 border-b border-gray-400 bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300">
          <div >
            <h4 className="text-xl font-medium">Add User Role</h4>
          </div>
        </div>
      </DialogTitle>
      <DialogContent>
        <div>
          <div className="w-full md:w-7/12 px-1 lg:w-8/12 xl:w-8/12 relative dark:bg-gray-700 dark:text-gray-200" style={{ position: 'relative', overflow: 'hidden', width: '100%', height: '100%' }}>
            <div>
