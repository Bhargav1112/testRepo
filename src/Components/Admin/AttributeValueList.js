            ...
            <main class="h-full overflow-y-auto">
                <div class="container grid px-6 mx-auto">
                    <div className='flex items-center justify-between border-b-2 border-gray-400'>
                        <h1 class="my-6 text-lg font-bold text-gray-700 dark:text-gray-300">Attribute value List</h1>
                        ...
                        <AddAttributeValue isOpen={isOpen} setIsOpen={setIsOpen} />
                    </div>
                                    ...
                                    currentPosts.map((item, i) => {
                                        return (
                                            <tr class="bg-white border-b odd:bg-white-900 even:bg-gray-100 dark:border-gray-700 dark:odd:bg-gray-900 dark:even:bg-gray-800">
                                                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white w-[150px]">
                                                    {i + 1}
                                                </th>
                                                <td class="px-6 py-4">
                                                    {item.YN}
